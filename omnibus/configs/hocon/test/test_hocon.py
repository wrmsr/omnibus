...
def test_hocon():
    with open(os.path.join(os.path.dirname(__file__), 'confs/simple1.conf'), 'r') as f:
        res1 = parsing.parse(f.read())
    with open(os.path.join(os.path.dirname(__file__), 'confs/simple2.conf'), 'r') as f:
    ...
    with open(os.path.join(os.path.dirname(__file__), 'confs/references.conf'), 'r') as f:
