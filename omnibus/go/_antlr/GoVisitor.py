...
class GoVisitor(ParseTreeVisitor):
    ...
    def visitAnonymousField(self, ctx:GoParser.AnonymousFieldContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by GoParser#sliceNode.
    def visitSliceNode(self, ctx:GoParser.SliceNodeContext):
        return self.visitChildren(ctx)
