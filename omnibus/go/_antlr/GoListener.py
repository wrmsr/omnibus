...
class GoListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by GoParser#sliceNode.
    def enterSliceNode(self, ctx:GoParser.SliceNodeContext):
        pass

    # Exit a parse tree produced by GoParser#sliceNode.
    def exitSliceNode(self, ctx:GoParser.SliceNodeContext):
        pass
